          ...
          <div className={s.cardInfo}>
            <div className={s.cardAbout}>
              ...
              <p className={s.cardAboutText}>
                Creating a portfolio prototype that will allow the developer to
                easily and effectively present their achievements, projects, and
                skills to their future employer.
              </p>
            </div>
        ...
        <div className={s.card}>
          ...
          <div className={s.cardInfo}>
            <div className={s.cardAbout}>
              ...
              <p className={s.cardAboutText}>
                Our website offers an easy way to search for high-quality images
                for any need, from personal projects to professional design. Our
                platform helps you quickly find the perfect image.
              </p>
            </div>
            <div className={s.cardDetails}>
              <div className={s.cardDetailsInfo}>
          ...
          <div className={s.cardInfo}>
            <div className={s.cardAbout}>
              ...
              <p className={s.cardAboutText}>
                ...
                find information about the film, its rating, and cast. This will
                help you make the best choice for your viewing.
              </p>
            </div>
            <div className={s.cardDetails}>
              <div className={s.cardDetailsInfo}>
